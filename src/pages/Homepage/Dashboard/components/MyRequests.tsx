...
const RequestItem: React.FC<{ request: any }> = ({ request }) => (
...
const MyRequests: React.FC = () => {
    const requests = mockDashboardData.myRequests;
    return (
        <div className="bg-white rounded-xl shadow-sm">
            <h2 className="text-lg font-bold text-brand-text-dark p-6">My Requests</h2>
