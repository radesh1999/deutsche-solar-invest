...
import { recommendatioinsData } from './recommendationData';

const RecommendationsChart: React.FC = () => {
    const [showSubmitted, setShowSubmitted] = useState(true);
    const [showSettled, setShowSettled] = useState(true);

    const transformedData = recommendatioinsData.chartData.labels.map((label, index) => ({
        name: label,
        submitted: recommendatioinsData.chartData.submitted[index],
        settled: recommendatioinsData.chartData.settled[index],
    }));
