                    ...
                    {employees.map((employee) => (
                        ...
                        >
                            ...
                            <td className="px-6 py-4 text-right space-x-4">
                                <FiEdit2 className="inline-block cursor-pointer text-[#667085] hover:text-[#005738]" />
                                <RiDeleteBinLine className="inline-block cursor-pointer text-[#B10000] hover:text-red-500" />
                            </td>
                        </tr>
                    ))}
                </tbody>
